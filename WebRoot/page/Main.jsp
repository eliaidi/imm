  ...
  <body  class="easyui-layout">
	...
	<div data-options="region:'north',split:false,border:false" class="head"
		...
		<span style="float: right; padding-right: 20px;">
			<a href="#" onclick="alertMessageByCode('滴答滴')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-user'">${sessionScope.USER_INFO.name}</a>
		...
		<span style="padding-left: 10px; font-size: 16px;">
			<a href="#" onclick="alertMessageByCode('滴答滴')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-synchro'"><s:text name="COMMON_TITLE"></s:text></a> 
		</span>
	</div>
